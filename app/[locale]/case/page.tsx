...
export default function CasePage() {
  const cases = [
    ...
    { id: 4, type: 'video', title: 'airRing', src: '/case/automatic_air_ring_video1.mp4', poster: '/case/automatic_air_ring_1.webp' },
    ...
    { id: 10, type: 'video', title: 'airRing', src: '/case/automatic_air_ring_video2.mp4', poster: '/case/automatic_air_ring_2.webp' },
    { id: 11, type: 'video', title: 'airRing&dosing', src: '/case/air_ring_dosing.mp4', poster: '/case/air_ring_dosing_poster.jpg' },
    { id: 12, type: 'video', title: 'airRing&dosing', src: '/case/air_ring_dosing2.mp4', poster: '/case/air_ring_dosing_poster2.webp' },
  ]
  return (
    <>
