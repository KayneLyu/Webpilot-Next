    ...
    return (
        <a href={link}>
            <span className="group">
                <span className="text-3 text-[16px] md:text-[20px] font-[family-name:var(--font-Roboto-Condensed)] inline-block transition-all duration-300 ease-in-out group-hover:translate-x-4 mr-6">{text}</span>
                <span>
